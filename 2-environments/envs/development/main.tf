...
module "env" {
  ...
  org_id                     = var.org_id
  monitoring_billing_account         = var.dev_monitoring_billing_account
  secrets_billing_account            = var.dev_secrets_billing_account
  shared_base_billing_account        = var.dev_shared_base_billing_account
  shared_restricted_billing_account  = var.dev_shared_restricted_billing_account
