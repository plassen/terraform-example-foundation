...
module "env" {
  ...
  org_id                     = var.org_id
  monitoring_billing_account         = var.nonprod_monitoring_billing_account
  secrets_billing_account            = var.nonprod_secrets_billing_account
  shared_base_billing_account        = var.nonprod_shared_base_billing_account
  shared_restricted_billing_account  = var.nonprod_shared_restricted_billing_account
