...
locals {
  base_shared_vpc_billing_account = var.base_shared_vpc_billing_account != "" ? var.base_shared_vpc_billing_account : var.billing_account
}
...
module "base_shared_vpc_project" {
  ...
  org_id                      = var.org_id
  billing_account             = local.base_shared_vpc_billing_account
  ...
  billing_code      = lower(local.base_shared_vpc_billing_account)
