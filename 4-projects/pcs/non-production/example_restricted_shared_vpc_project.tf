...
locals {
  restricted_shared_vpc_billing_account = var.restricted_shared_vpc_billing_account != "" ? var.restricted_shared_vpc_billing_account : var.billing_account
}
...
module "restricted_shared_vpc_project" {
  ...
  org_id                      = var.org_id
  billing_account             = local.restricted_shared_vpc_billing_account
  ...
  billing_code      = lower(local.restricted_shared_vpc_billing_account)
