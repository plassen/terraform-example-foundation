...
locals {
  storage_cmek_billing_account = var.storage_cmek_billing_account != "" ? var.storage_cmek_billing_account : var.billing_account
}
...
module "env_secrets_project" {
  ...
  org_id                      = var.org_id
  billing_account             = local.storage_cmek_billing_account
  ...
  billing_code      = lower(local.storage_cmek_billing_account)
