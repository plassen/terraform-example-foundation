...
locals {
  ...
  peering_billing_account = var.peering_billing_account != "" ? var.peering_billing_account : var.billing_account
}
...
module "peering_project" {
  ...
  org_id                      = var.org_id
  billing_account             = local.peering_billing_account
  ...
  billing_code      = lower(local.peering_billing_account)
